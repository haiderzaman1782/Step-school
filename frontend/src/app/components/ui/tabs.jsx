...
import * as RadixUI from "@radix-ui/react-tabs";

import { cn } from "./utils.js";

const TabsPrimitive = RadixUI;
...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "bg-muted text-muted-foreground inline-flex h-9 w-fit items-center justify-center rounded-xl p-[3px] gap-2",
        className,
      )}
      {...props}
    />
