        ...
        <div className="client-list-container space-y-8 animate-in fade-in duration-700">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="title-group">
                    <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight text-primary leading-tight">School Clients</h1>
                    <p className="text-muted-foreground mt-1 text-sm font-bold opacity-70">Institutional accounts and structures.</p>
                </div>
                <button
                    className="w-full md:w-auto bg-primary hover:bg-primary/90 text-primary-foreground px-6 py-3 rounded-2xl font-bold flex items-center justify-center transition-all shadow-sm"
                    onClick={onAdd}
                >
